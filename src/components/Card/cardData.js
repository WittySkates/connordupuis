export const experienceData = {
    ...
    RaymondJames2021:{
        title:"Raymond James",
        tldr: "Intership Summer 2021",
        description: "Creating reporting analytics, analyzing numerous data sources across Raymond James, and utilizing the ServiceNow platform to develop tools for easy data access.",
        languages: ["ServiceNow", "Python", "SQL", "Tableau", "Scikit-learn"],
    },
    RaymondJames2020:{
        title:"Raymond James",
